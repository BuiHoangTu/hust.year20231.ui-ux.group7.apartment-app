      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // successiconyJu (339:2828)
                    width: 48*fem,
                    height: 66*fem,
                    child: Image.asset(
                      'assets/templates/images/success-icon.png',
                      fit: BoxFit.contain,
                    ),
                  ),
                ],
            ...
            Container(
              // frame396268d (339:2829)
              width: 108*fem,
              height: 54*fem,
              child: Container(
                // framenotificationSyB (339:2830)
                width: double.infinity,
                height: double.infinity,
                decoration: BoxDecoration (
